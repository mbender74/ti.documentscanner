...
import ti.documentscanner.enums.QuadCorner
import ti.documentscanner.extensions.changeByteCountByResizing
import ti.documentscanner.extensions.drawQuad
...
class ImageCropView(context: Context, attrs: AttributeSet) : AppCompatImageView(context, attrs) {
    ...
    fun setImagePreviewBounds(photo: Bitmap, screenWidth: Int, screenHeight: Int, buttonsOffset : Int = 0) {
        ...
        val buttonsViewMinHeight = context.resources.getDimension(
            R.dimen.buttons_container_height
        ).toInt() - buttonsOffset
...
//        imagePreviewHeight = (screenHeight - R.dimen.buttons_container_height).toInt()
