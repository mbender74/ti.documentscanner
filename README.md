...
<modules>
  <module version="1.0.0">de.marcbender.documentscanner</module>
</modules>
...
```js
import MyModule from 'de.marcbender.documentscanner';
MyModule.foo();
```
...
```js
var MyModule = require('de.marcbender.documentscanner');
MyModule.foo();
```
